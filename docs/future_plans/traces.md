...
Locations need avenues of ingress appropriate to their location type (front door, back door, window, etc.)

We need to add a system for different people to use different types of ingress, (patrons use a front door of a business, employees may use a front door or back door, but for an Office things are completely different - employees will first go to a Lobby, followed by elevator (or stairs), followed by the office front door - that's the concept of sub-locations which I think we need to explore either in this feature or immeidately thereafter).

We need to add the concept of locked doors, and by extension keys. We need to have homeowners have an objective to lock their doors before going to bed, with a chance to forget.
...
Keys themselves should have fingerprints left on them to, by anyone picking one up or using it, following similar fingerprint rules.